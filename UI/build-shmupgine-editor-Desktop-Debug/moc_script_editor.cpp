...
struct qt_meta_stringdata_script_editor_t {
    QByteArrayData data[4];
    char stringdata0[38];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_script_editor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_script_editor_t qt_meta_stringdata_script_editor = {
    {
QT_MOC_LITERAL(0, 0, 13), // "script_editor"
QT_MOC_LITERAL(1, 14, 11), // "disable_btn"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 10) // "enable_btn"

    },
    "script_editor\0disable_btn\0\0enable_btn"
};
...
const QMetaObject script_editor::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_script_editor.data,
      qt_meta_data_script_editor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *script_editor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_script_editor.stringdata0))
