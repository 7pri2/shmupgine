...
struct qt_meta_stringdata_destructor_t {
    QByteArrayData data[5];
    char stringdata0[57];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_destructor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_destructor_t qt_meta_stringdata_destructor = {
    {
QT_MOC_LITERAL(0, 0, 10), // "destructor"
QT_MOC_LITERAL(1, 11, 18), // "open_select_entity"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 12), // "selectEntity"
QT_MOC_LITERAL(4, 44, 12) // "removeEntity"

    },
    "destructor\0open_select_entity\0\0"
    "selectEntity\0removeEntity"
};
...
const QMetaObject destructor::staticMetaObject = {
    { &attribute_widget::staticMetaObject, qt_meta_stringdata_destructor.data,
      qt_meta_data_destructor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *destructor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_destructor.stringdata0))
