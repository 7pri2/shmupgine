...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_new_project_t, stringdata) + ofs \
...
const QMetaObject new_project::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_new_project.data,
      qt_meta_data_new_project,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_new_project.stringdata))
