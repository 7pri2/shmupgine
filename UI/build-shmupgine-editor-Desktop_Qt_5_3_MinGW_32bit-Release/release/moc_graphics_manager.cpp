...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_graphics_manager_t, stringdata) + ofs \
...
const QMetaObject graphics_manager::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_graphics_manager.data,
      qt_meta_data_graphics_manager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_graphics_manager.stringdata))
