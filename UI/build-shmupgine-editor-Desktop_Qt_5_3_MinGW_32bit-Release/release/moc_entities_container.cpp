...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_entities_container_t, stringdata) + ofs \
...
const QMetaObject entities_container::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_entities_container.data,
      qt_meta_data_entities_container,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_entities_container.stringdata))
